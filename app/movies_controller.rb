...
def can_be_found_updated_and_saved
  ...
  movie_record = Movie.find_by(title: "Awesome Flick")
...
def can_update_using_update_method
  ...
  movie_record = Movie.find_by(title: "Wat?")
  movie_id = movie_record[:id]
...
def can_destroy_a_single_item
  ...
  movie_record = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  movie_id = movie_record[:id]
